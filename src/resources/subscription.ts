...
import type { CreateSubscriptionBody, FetchSubscriptionData, GenerateLinkData, ListSubscriptionQueries, ListSubscriptionsDatum, ListSubscriptionsMeta, ToggleSubscriptionBody } from "../types/subscription.ts";
...
export default class Subscription extends PaystackShared {
   ...
   */
  public create = async (body: CreateSubscriptionBody): Promise<PaystackResponseInterface<CreateSubscriptionBody> | null> => {
    const url = this.resourceUrl;
    const method = 'POST';

    return await this.paystackFetch<CreateSubscriptionBody>(url, method, body as unknown as Record<string, unknown>);
  }
   ...
   */
  public list = async (queries: ListSubscriptionQueries): Promise<PaystackResponseInterface<ListSubscriptionsDatum[], ListSubscriptionsMeta> | null> => {
    const url = this.resourceUrl;
    const method = 'GET';

    return await this.paystackFetch<ListSubscriptionsDatum[], ListSubscriptionsMeta>(url, method, {}, {}, queries as unknown as Record<string, unknown>);
  }
   ...
   */
  public fetch = async (idOrCode: string): Promise<PaystackResponseInterface<FetchSubscriptionData> | null> => {
    const url = this.resourceUrl + '/:idOrCode';
    const method = 'GET';

    return await this.paystackFetch<FetchSubscriptionData>(url, method, {}, { idOrCode });
  }
   ...
   */
  public enable = async (body: ToggleSubscriptionBody): Promise<PaystackResponseInterface<undefined> | null> => {
   ...
   * @returns {Promise<PaystackResponseInterface<undefined> | null>} response - A promise that resolves to an object with a boolean status property and a message property
   */
  public disable = async (body: ToggleSubscriptionBody): Promise<PaystackResponseInterface<undefined> | null> => {
   ...
   */
  public generateLink = async (code: string): Promise<PaystackResponseInterface<GenerateLinkData> | null> => {
    const url = this.resourceUrl + '/:code/manage/link';
    const method = 'GET';

    return await this.paystackFetch<GenerateLinkData>(url, method, {}, { code });
  }
   ...
   * @returns {Promise<PaystackResponseInterface<undefined> | null>} response - A promise that resolves to an object with a boolean status property and a message property
   */
  public sendLink = async (code: string): Promise<PaystackResponseInterface<undefined> | null> => {
