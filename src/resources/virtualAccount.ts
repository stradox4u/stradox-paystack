...
import type {
  AssignVirtualAccountBody,
  CreateVirtualAccountBody,
  CreateVirtualAccountData,
  DeactivateVirtualAccountData,
  FetchProvidersDatum,
  FetchVirtualAccountData,
  ListVirtualAccountQueries,
  ListVirtualAccountsDatum,
  ListVirtualAccountsMeta,
  RemoveSplitData,
  RequeryVirtualAccountQueries,
  SplitTransactionData,
  SplitVirtualAccountTransactionBody,
} from "../types/virtualAccounts.ts";
...
export default class DedicatedVirtualAccount extends PaystackShared {
  ...
  ): Promise<PaystackResponseInterface<CreateVirtualAccountData> | null> => {
    const url = this.resourceUrl;
    const method = "POST";

    return await this.paystackFetch<CreateVirtualAccountData>(
      url,
      method,
   ...
   */
  public list = async (
    queries: ListVirtualAccountQueries,
  ): Promise<
  ...
  public fetch = async (
    accountId: string,
  ): Promise<PaystackResponseInterface<FetchVirtualAccountData> | null> => {
    const url = this.resourceUrl + "/:accountId";
    const method = "GET";

    return await this.paystackFetch<FetchVirtualAccountData>(url, method, {}, {
      accountId,
    });
  };
   ...
   * @returns {Promise<PaystackResponseInterface<undefined> | null>} response - A promise that resolves to the PaystackResponseInterface type, with a boolean status property and a message property
   */
  public requery = async (
    queries: RequeryVirtualAccountQueries,
  ): Promise<PaystackResponseInterface<undefined> | null> => {
  ...
  public deactivate = async (
    ...
    PaystackResponseInterface<DeactivateVirtualAccountData> | null
  > => {
    const url = this.resourceUrl + "/:accountId";
    const method = "DELETE";

    return await this.paystackFetch<DeactivateVirtualAccountData>(
      url,
      method,
      {},
      { accountId },
   ...
   */
  public split = async (
    body: SplitVirtualAccountTransactionBody,
  ): Promise<PaystackResponseInterface<SplitTransactionData> | null> => {
    const url = this.resourceUrl + "/split";
    const method = "POST";

    return await this.paystackFetch<SplitTransactionData>(
      url,
      method,
      body as unknown as Record<string, unknown>,
    );
   ...
   */
  public removeSplit = async (
    body: { account_number: string },
  ): Promise<PaystackResponseInterface<RemoveSplitData> | null> => {
    const url = this.resourceUrl + "/split";
    const method = "DELETE";

    return await this.paystackFetch<RemoveSplitData>(
      url,
      method,
      body as unknown as Record<string, unknown>,
    );
   ...
   */
  public fetchProviders = async (): Promise<
    PaystackResponseInterface<FetchProvidersDatum[]> | null
  > => {
